...
public interface SessionPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return performAction(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int performAction(java.util.Map<String, String> context)
    {
        return _iceI_performActionAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Integer> performActionAsync()
    {
        return _iceI_performActionAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Integer> performActionAsync(java.util.Map<String, String> context)
    {
        return _iceI_performActionAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Integer> _iceI_performActionAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "performAction", null, sync, null);
    ...
    default String getSessionInfo()
    {
        return getSessionInfo(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getSessionInfo(java.util.Map<String, String> context)
    {
        return _iceI_getSessionInfoAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<String> getSessionInfoAsync()
    {
        return _iceI_getSessionInfoAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String> getSessionInfoAsync(java.util.Map<String, String> context)
    {
        return _iceI_getSessionInfoAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<String> _iceI_getSessionInfoAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getSessionInfo", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     String ret;
                     ret = istr.readString();
                     return ret;
